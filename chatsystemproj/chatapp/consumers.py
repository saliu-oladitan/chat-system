...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        # You need to accept the incoming websocket connection from the client/browser: # accept websocket connections - await self.accept()
...
# The ChatConsumer class is the handler of all websocket requests